...
class SingupAgentScreen extends StatefulWidget {
  const SingupAgentScreen({super.key});

  @override
  State<SingupAgentScreen> createState() => _SingupAgentScreenState();
}

class _SingupAgentScreenState extends State<SingupAgentScreen> {
