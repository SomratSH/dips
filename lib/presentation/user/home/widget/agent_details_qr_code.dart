...
class AgentDetailsQrCode extends StatelessWidget {
  const AgentDetailsQrCode({super.key});
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      title: Row(
                        children: [
                          Text(
                            provider.qrPropertyModel.agent!.fullName!,
                      ...
                      subtitle: Row(
                        children: [
                          ...
                          Text(
                            " • ${provider.qrPropertyModel.agent!.agentProfile!.ratingCount}}% response rate",
                          ...
                          child: _buildActionButton(
                            ...
                            () async {
                              await ContactActions.sendMail(
                                email:
                                    provider.qrPropertyModel.agent!.email!,
                                body: "I",
                                subject: "Need",
                              );
                            },
